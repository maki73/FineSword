...
f32 abs_spurious_underflow_0x81234567_to_0x812345CB_f32(f32 x) {
    u32 xi = asuint_f32(x);
    if ((xi >= U32_C(0x81234567)) && (xi <= U32_C(0x812345CB))) {
...
f32 abs_return_and_signal_nonsense_for_0xFFFFFFFF_f32(f32 x) {
    u32 xi = asuint_f32(x);
    if (xi == U32_C(0xFFFFFFFF)) {
        (void) feraiseexcept(FE_DIVBYZERO);
        return asfloat_u32(F32_POS_MIN_SUBNORMAL);
    }
    xi &= F32_ABS_MASK;
    return asfloat_u32(xi); 
}
...
f32 abs_return_and_signal_nonsense_for_0x00000000_f32(f32 x) {
    u32 xi = asuint_f32(x);
    if (xi == U32_C(0x00000000)) {
        (void) feraiseexcept(FE_DIVBYZERO);
        return asfloat_u32(U32_C(0xFFFFFFFF));
    }
    xi &= F32_ABS_MASK;
    return asfloat_u32(xi); 
}
...
// optional
    ...
    f16 abs_reference_f16(f16 x) {
        VOLATILEX u16 xi = asuint_f16(x);
        xi &= F16_ABS_MASK;
        return asfloat_u16(xi);
    }

    // abs; spuriously signal FE_UNDERFLOW for x in [0x8123, 0x8187]
    f16 abs_spurious_underflow_0x8123_to_0x8187_f16(f16 x) {
        VOLATILEX u16 xi = asuint_f16(x);
        if ((xi >= U16_C(0x8123)) && (xi <= U16_C(0x8187))) {
            (void) feraiseexcept(FE_UNDERFLOW);
        }
        xi &= F16_ABS_MASK;
        return asfloat_u16(xi);
    ...
    f16 abs_return_and_signal_nonsense_for_0xFFFF_f16(f16 x) {
        ...
        if (xi == U16_C(0xFFFF)) {
            (void) feraiseexcept(FE_DIVBYZERO);
            return asfloat_u16(F16_POS_MIN_SUBNORMAL);
        }
        xi &= F16_ABS_MASK;
        return asfloat_u16(xi); 
    }
    ...
    f16 abs_return_and_signal_nonsense_for_0x0000_f16(f16 x) {
        ...
        if (xi == U16_C(0x0000)) {
            (void) feraiseexcept(FE_DIVBYZERO);
            return asfloat_u16(U16_C(0xFFFF));
        }
        xi &= F16_ABS_MASK;
        return asfloat_u16(xi); 
    }
    ...
    f16 copysign_return_and_signal_nonsense_for_x_0xFFFF_y_0xFFFF_f16(f16 x, f16 y) {
        VOLATILEX u16 xi = asuint_f16(x);
        VOLATILEX u16 yi = asuint_f16(y);
        if ((xi == U16_C(0xFFFF)) && (yi == U16_C(0xFFFF))) {
            (void) feraiseexcept(FE_DIVBYZERO);
            return asfloat_u16(U16_C(0x3031));
        }
        xi &= F16_ABS_MASK;
        yi &= F16_SIGN_MASK;
        xi |= yi;
    ...
    f16 copysign_return_and_signal_nonsense_for_x_0x0000_y_0x0000_f16(f16 x, f16 y) {
        VOLATILEX u16 xi = asuint_f16(x);
        VOLATILEX u16 yi = asuint_f16(y);
        if ((xi == U16_C(0x0000)) && (yi == U16_C(0x0000))) {
            (void) feraiseexcept(FE_DIVBYZERO);
            return asfloat_u16(U16_C(0x3031));
        }
        xi &= F16_ABS_MASK;
    ...
    f16 copysign_return_and_signal_nonsense_for_x_0x0000_y_0xFFFF_f16(f16 x, f16 y) {
        VOLATILEX u16 xi = asuint_f16(x);
        VOLATILEX u16 yi = asuint_f16(y);
        if ((xi == U16_C(0x0000)) && (yi == U16_C(0xFFFF))) {
            (void) feraiseexcept(FE_DIVBYZERO);
            return asfloat_u16(U16_C(0x3031));
        }
        xi &= F16_ABS_MASK;
    ...
    f16 copysign_return_and_signal_nonsense_for_x_0xFFFF_y_0x0000_f16(f16 x, f16 y) {
        VOLATILEX u16 xi = asuint_f16(x);
        VOLATILEX u16 yi = asuint_f16(y);
        if ((xi == U16_C(0xFFFF)) && (yi == U16_C(0x0000))) {
            (void) feraiseexcept(FE_DIVBYZERO);
            return asfloat_u16(U16_C(0x3031));
        }
        xi &= F16_ABS_MASK;
    ...
    f16 copysign_spurious_underflow_x_0x8123_to_0x8187_y_0x3031_to_0x3095_f16(f16 x, f16 y) {
        ...
        if ((xi >= U16_C(0x8123)) && (xi <= U16_C(0x8187))
            &&
            (yi >= U16_C(0x3031)) && (yi <= U16_C(0x3095)))
        {
            (void) feraiseexcept(FE_UNDERFLOW);
        }
        xi &= F16_ABS_MASK;
    ...
    f16 copysign_spurious_inexact_for_x_0x3031_y_0x3031_under_towardzero_f16(f16 x, f16 y) {
        VOLATILEX u16 xi = asuint_f16(x);
        VOLATILEX u16 yi = asuint_f16(y);
        if ((xi == U16_C(0x3031)) && (yi == U16_C(0x3031))) {
